              ...
              <div className="card shadow mb-4">
                ...
                <div className="card-body">
                  ...
                  <div className="progress mb-4">
                                        <div className="progress-bar bg-danger" role="progressbar" style={{ width: "20%", ariaValuenow: "20", ariaValuemin: "0", ariaVluemax: "100" }}></div>
                  </div>
                  ...
                  <div className="progress mb-4">
                                        <div className="progress-bar bg-info" role="progressbar" style={{ width: "80%", ariaValuenow: "80", ariaValuemin: "0", ariaValuemax: "100" }}></div>
                  </div>
